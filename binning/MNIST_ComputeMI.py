...
MAX_EPOCHS = 3500     # Max number of epoch for which to compute mutual information measure
# MAX_EPOCHS = 3500
COLORBAR_MAX_EPOCHS = 3500
    ...
    for epochfile in sorted(os.listdir(cur_dir)):
        ...
        for lndx in range(num_layers):
            ...
            if DO_BINNED: # Compute binner estimates
                binxm, binym = simplebinmi.bin_calc_information2(saved_labelixs, activity, sz)
